 ...
 */
function getNotifications(userId, status, offset, limit, serverdatetime, fromdate, todate, cb) {
  var query = {
 ...
 * @param  {Function} cb     Callback function
 */
function markRead(notificationId, userId, cb) {
  updateNotificationStatus(notificationId, userId, notificationStatusMapping['READ'], function(response) {
    cb(response);
  });
}
 ...
 * @param  {Function} cb     Callback function
 */
function markUnread(notificationId, userId, cb) {
  updateNotificationStatus(notificationId, userId, notificationStatusMapping['UNREAD'], function(response) {
    cb(response);
  });
}

function updateNotificationStatus(notificationId, userId, status, cb) {
  var query = {
    table: 'tbl_InappNotification',
    update: [{
      field: 'IN_status',
 ...
 */
function getNewNotifications(userId, datetime, cb) {
  var query = {
    table: 'tbl_InappNotification',
    select: [{
      field: 'pk_id',
